...
class ingresar_app : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnIniciar.setOnClickListener {view: View->
            val id=getUserId(getString(binding.txtEmailLogin),getString(binding.txtContrasena))
            view.findNavController().navigate(R.id.action_ingresar_app_to_perfil_medico_app)
        }
        Toast.makeText(context,"Click",Toast.LENGTH_LONG).show()
    }
